...
static int c_main(long argc, char **argv, char **envp)
{
	...
	char faccessat2_template[] = "[1] faccessat2:\t";
...
start_loop:
	...
	faccessat2_template[1] = 49 + j;
    
	run_bench(SYS_faccessat, AT_FDCWD, (long)tests[j], F_OK, NULL, NULL, NULL, faccessat_template, result_template);
	run_bench(SYS_faccessat2, AT_FDCWD, (long)tests[j], F_OK, 0, NULL, NULL, faccessat2_template, result_template);
